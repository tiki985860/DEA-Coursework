...
public class loginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        javaBeans.loginVerify lgv = new javaBeans.loginVerify();
        if(lgv.verify(un, pass))
        {
            javaBeans.AllUsers user = new javaBeans.AllUsers();
            int userid = user.getUserId(un);
            ...
            //out.println("<html><head><style = '/../../css/style.css'> </style></head>" );
            //out.print("Invalid login credentials");
            
            //out.println("<html><body onload=\"alert('Invlaid credentials')\"></body></html>");
